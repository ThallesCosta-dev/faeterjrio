...
export function FloatingNavbar() {
  ...
  const menuItems = [
    ...
    { label: "Ingresso", href: "/admissao" },

    { label: "Horários", href: "/grade-de-horarios" },
            ...
            <img
              ...
              style={{
                ...
                filter: scrolled
                  ...
                  ? 'brightness(0) saturate(100%) invert(24%) sepia(60%) saturate(500%) hue-rotate(195deg) brightness(97%)'
