-- =====================================================
-- MINI-CMS FAETERJ-RIO: Setup Completo (Versão Safe)
-- =====================================================
-- 
-- Este script verifica se as tabelas já existem antes de criar
-- Evita erros de "already exists"
-- =====================================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'post_status') THEN
        ...
        RAISE NOTICE 'Tipo post_status criado';
    ELSE
        RAISE NOTICE 'Tipo post_status já existe';
    END IF;
END $$;
